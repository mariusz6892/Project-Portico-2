 ...
 */
public class KasaAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public KasaAmbassador( Kasa federate )
	{
	...
	public void announceSynchronizationPoint( String label, byte[] tag )
	{
		...
		if( label.equals(Kasa.READY_TO_RUN) )
	    ...
	    throws FederateInternalError
	{
		...
		for( ParameterHandle parameter : theParameters.keySet() )
		{
			...
			{
				builder.append( parameter );
				builder.append( " Typ zg³oszenia    " );
				builder.append( ", parameterValue=" );
				builder.append( decodetyp_zgloszenia(theParameters.get(parameter)) );
				if (decodetyp_zgloszenia(theParameters.get(parameter)) == 3) {
					typzgloszenia = 3;
				}
			...
			else if( parameter.equals(federate.czas_wykonaniaHandle) )
			{
				...
				if (federate.kasa.czywolny == true && typzgloszenia == 3) {
			...
			else if( parameter.equals(federate.nr_samochoduHandle) )
			{
				...
				if (federate.kasa.getczywolny() && typzgloszenia == 3) {
						federate.kasa.obslugiwanysamochod = decodenrsamochodu(theParameters.get(parameter));
			...
			{
				builder.append( parameter );
				builder.append( " Czas zakoñczenia    " );
				builder.append( ", parameterValue=" );
			...
			else if( parameter.equals(federate.stanowiskozHandle) )
			{
				...
				if (stanowisko == 1 && (czas_zakonczenia % 2 == 1)) federate.dlugosc_kolejki++;
				else if (stanowisko == 2) federate.dlugosc_kolejki++;
			}
